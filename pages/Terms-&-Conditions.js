  ...
  return (
    <>
      ...
      <div className="transition duration-500 ease transform hover:-translate-y-1 inline-block items-center lg:items-center px-6 py-3">
        ...
        <p className="my-3">Last updated: 2022-11-20</p>
        <p className="my-3">
        ...
        <p className="my-3">
          ...
          located at{" "}
          <b>
            <a href="https://www.uquicks.com" className="hover:text-red-700">
              uquicks.com
            </a>
          </b>{" "}
        ...
        <p className="my-3">
          ...
          <b>asimwegers96@gmail.com</b> so we can try to find a solution. These
          Terms apply to all visitors, users and others who wish to access or
          use Service.
        </p>
        <p className="my-3">
          <b className="text-3xl font-semibold">2. Communications</b>
        </p>
        <p className="my-3">
          ...
          <b>asimwegers96@gmail.com.</b>
        </p>
        <p className="my-3">
          <b className="text-3xl font-semibold">3. Purchases</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">5. Refunds</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">6. Content</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">7. Prohibited Uses</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">Additionally, you agree not to:</p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">8. Analytics</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">9. No Use By Minors</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">10. Accounts</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">11. Intellectual Property</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          ...
          to <b>asimwegers96@gmail.com</b>, with the subject line: “Copyright
        ...
        <p className="my-3">
          You may provide us either directly at <b>asimwegers96@gmail.com</b> or
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">15. Links To Other Web Sites</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">16. Disclaimer Of Warranty</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">17. Limitation Of Liability</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">18. Termination</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">19. Governing Law</b>
        </p>
        <p className="my-3">
          These Terms shall be governed and construed in accordance with the
          laws of Uganda, which governing law applies to agreement without
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">20. Changes To Service</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">21. Amendments To Terms</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">22. Waiver And Severability</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">23. Acknowledgement</b>
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          <b className="text-3xl font-semibold">24. Contact Us</b>
        </p>
        <p className="my-3">
          Please send your feedback, comments, requests for technical support by
          email: <b>asimwegers96@gmail.com</b>.
        </p>
        <p className="my-3">
          These{" "}
          <a href="https://policymaker.io/terms-and-conditions/">
