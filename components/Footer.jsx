...
const Footer = () => {
  return (
    <div className="mt-16">
      <footer className="bg-black text-white backdrop-blur w-full ">
        <div className="py-12 spacing flex flex-col md:flex-row md:justify-between text-center md:mx-6">
          {/* Main Grid */}
          <section className=" grid md:grid-cols-3 md:gap-4 lg:gap-12 justify-items-center desktop:gap-24">
            ...
            <div className="mb-10 ">
              ...
              {/* Social media */}
              <div className="mx-auto grid grid-cols-5 gap-x-3 mt-6 text-red-800">
                <Link
                  href="https://www.facebook.com/profile.php?id=100088305281566&sk=about"
                  target="_blank"
                >
          ...
          {/* Copyright */}
          <section className="md:text-right font-semibold cursor-pointer md:r-4 lg:r-4 lg:pr-5">
            <Link
